...
const LoginForm = ({ onClose }) => { // Change setIsOpen to onClose
  const [isSignUp, setIsSignUp] = useState(false);
  const [isForgot, setIsForgot] = useState(false);

  // The event listener is correct, but the prop name was wrong.
  const handleOverlayClick = (e) => {
    if (e.target.id === "overlay") {
      onClose(); // Use the corrected prop name
    }
  };
        ...
        {isForgot ? (
          ...
          <>
            ...
            <div className="hidden sm:block">
              ...
              >
                <form className="bg-white flex flex-col items-center justify-center px-8 sm:px-14 h-full text-center">
